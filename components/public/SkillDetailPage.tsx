        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          <Card className="p-4 space-y-1">
            <div className="flex items-center gap-1">
              <Users size={10} className="text-[var(--color-text-tertiary)]" />
              <p className="text-[10px] font-semibold uppercase tracking-wider text-[var(--color-text-tertiary)]">
                Practitioners
              </p>
            </div>
      ...
      {marketState && marketState.practitioner_count > 0 && (
        <Card className="p-4 space-y-3">
          ...
          <div className="flex gap-1 h-6 rounded-full overflow-hidden">
            {(
              [
                { key: "exploring", label: "Exploring", color: "var(--color-text-tertiary)" },
                { key: "practicing", label: "Practicing", color: "var(--color-amber-600)" },
                { key: "proficient", label: "Proficient", color: "var(--color-cyan-700)" },
                { key: "advanced", label: "Advanced", color: "var(--color-green-700)" },
              ] as const
            ).map((level) => {
              const count =
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {paths.map((path) => (
              <a key={path.id} href={`/learn/paths/${path.id}`}>
                <Card className="p-4 space-y-2 transition-colors hover:bg-[var(--color-bg-hover)] cursor-pointer">
